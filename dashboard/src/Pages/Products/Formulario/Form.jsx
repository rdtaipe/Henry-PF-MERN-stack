  ...
  const getModule = () => {
    get(url + `dev/module/product`).then((res) => {
      ...
      const data = res.data.filter((e) =>
        e["attributes"] ? e.attributes.input : null
      );
      const obj = {};
      data.forEach((e) => {
          ...
          >
            ...
            <div>
              ...
              {errors.name?.type === "maxLength" && (
                <p className="error">Only can use 35 letters</p>
              )}
            </div>
            <div>
              <input
              ...
              {errors.image?.type === "required" && (
                <p className="error">Image required</p>
              )}
            </div>
            {/*     
            ...
            <div>
              ...
              {errors.description?.type === "maxLength" && (
                <p className="error">Only can use 400 letters</p>
              )}
            </div>
            {/* container medio */}
            <div className="container2">
              <div>
                ...
                {errors.stock?.type === "required" && (
                  <p className="error">stock required</p>
                )}
              ...
              <div>
                ...
                {errors.price?.type === "required" && (
                  <p className="error">price required</p>
                )}
            ...
            <div>
              ...
              <button className="botonStyle" type="submit">
                Add Product
              </button>
            </div>
          </form>
